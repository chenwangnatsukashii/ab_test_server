...
const (
	...
	initialTime = int64(1667972427000) //初始毫秒,时间是: Wed Nov  9 13:40:27 CST 2022
)
...
func (w *Worker) GetID() int {
	...
	w.lastStamp = mill
	id := (w.lastStamp-initialTime)<<timeLeft | w.machineID<<machineLeft | w.serviceID<<serviceLeft | w.sequenceID
	return int(id)
}
